...
import Logo from '../../assets/GHC Logo_Black Background.jpg';
      ...
      <div className="flex w-full flex-col items-center justify-center gap-10 bg-slate-200 p-10 sm:flex-row md:p-20 ">
        ...
        <div className="flex basis-2/3 flex-col gap-5">
          ...
          <p className="text-xl font-medium text-secondary">
            ...
            preservation and the flourishing of bee populations. At Golden
            Harvest Collective, the objective is to deliver the purest honey
            while embracing the natural richness and ecological balance woven
            into the tapestry of South Africa’s honey history.
          </p>
        </div>
      </div>
